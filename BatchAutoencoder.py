...
class BatchAutoencoder:

    def __init__(self, lr=1e-5, topology=1, latent=2048, plot=True, loss='sparse_categorical_crossentropy'):
        ...
        self.checkpoint_path = "cp_batched/models/ae_" +\
    ...
    def train_autoencoder(self, epochs=3):
        ...
        plt.savefig('cp_batched/losses/loss' + str(self.id_topology) + '_latent' + str(self.latent_dimension) + '.png')
        if self.plot:
            plt.show()
        plt.clf()
